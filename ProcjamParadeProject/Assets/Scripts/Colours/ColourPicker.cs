...
//
    ...
    public void Start ()
    {
        ...
        //create materials and shades
        matsAndShades = Palette(hue, saturation, value);

        //hierarchy to see how many mats and shades
        matsAndShadesCount = matsAndShades.Count;
    ...
    void ChooseRandom()
    {
        ...
        //float valChooser = Random.Range(0.33f, .66f);//overide atm
         //value = valChooser;
        value = 1f;// 0.5f;//this really just controls how much lights is looking like it is hitting it, perhaps should be a constant
    ...
    MaterialAndShades ColourAndShades(float hueP,float saturationP,float valueP)
    {
        ...
        matMain.SetFloat("_Glossiness", glossiness);
        matMain.SetFloat("_Metallic", metallic);
    ...
    List<Material> Tints(float huePassed, float saturationPassed, float valuePassed)
    {
        ...
        for (int i = 0; i < tintsAndShades; i++) //less than or equal to because we are adding the main colour as a small colour too   
        {
            ...
            mat0.SetFloat("_Glossiness", glossiness);
            mat0.SetFloat("_Metallic", metallic);
